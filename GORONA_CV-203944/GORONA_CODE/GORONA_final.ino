const int MOTION_SENSOR_PIN = 9;   // Arduino pin connected to the OUTPUT pin of motion sensor
const int RELAY_PIN1         = 5;
const int RELAY_PIN1         = 6;                                   // Arduino pin connected to the IN pin of relay
...
void loop() {
  ...
  if (motionStatePrevious == LOW && motionStateCurrent == HIGH) { // pin state change: LOW -> HIGH
    ...
    digitalWrite(RELAY_PIN1,LOW); // turn on
